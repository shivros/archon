...
func DefaultHotkeys() []Hotkey {
	return []Hotkey{
		...
		{Key: "ctrl+g", Command: KeyCommandCopySelectionIDs, Label: "copy ids", Context: HotkeySidebar, Priority: 34},
		...
		{Key: "ctrl+g", Command: KeyCommandCopySelectionIDs, Label: "copy ids", Context: HotkeyChatInput, Priority: 12},
