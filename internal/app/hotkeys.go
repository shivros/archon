...
func DefaultHotkeys() []Hotkey {
	return []Hotkey{
		...
		{Key: "1/2/3", Label: "toggle note scope", Context: HotkeySidebar, Priority: 27},
		{Key: "0", Command: KeyCommandToggleNotesAll, Label: "all note scopes", Context: HotkeySidebar, Priority: 28},
