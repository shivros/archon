...
var (
	...
	settingsMenuBorderStyle         = lipgloss.NewStyle().Border(lipgloss.DoubleBorder()).BorderForeground(lipgloss.Color("63")).Background(lipgloss.Color("235")).Padding(1, 2)
	settingsMenuTitleStyle          = lipgloss.NewStyle().Foreground(lipgloss.Color("230")).Background(lipgloss.Color("239")).Bold(true).Padding(0, 1)
	settingsMenuOptionStyle         = lipgloss.NewStyle().Foreground(lipgloss.Color("249")).Background(lipgloss.Color("235"))
	settingsMenuOptionSelectedStyle = lipgloss.NewStyle().
					Foreground(lipgloss.Color("230")).
					Background(lipgloss.Color("238")).
					Bold(true)
	settingsMenuHelpTitleStyle     = lipgloss.NewStyle().Foreground(lipgloss.Color("117")).Bold(true)
	settingsMenuHelpHintStyle      = lipgloss.NewStyle().Foreground(lipgloss.Color("245"))
	settingsMenuHelpRowStyle       = lipgloss.NewStyle().Foreground(lipgloss.Color("252"))
	settingsMenuHintStyle          = lipgloss.NewStyle().Foreground(lipgloss.Color("244"))
